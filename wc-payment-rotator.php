...
// Автообновление из GitHub (релизы). Загружаем при каждой инициализации, чтобы
// срабатывало и при проверке обновлений по крону (не только в админке).
if (WC_PLR_GITHUB_REPO !== '') {
